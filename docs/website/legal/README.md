...
Open items that block go-live (also tracked in `../PRD.md` §11): legal entity name,
registered address, grievance/DPO name + email, retention period, contact email(s),
governing-law city, effective dates, bot-protection provider name, and an SDF
assessment. Data-collection facts the policy must reflect are in `../PRD.md` §8.
