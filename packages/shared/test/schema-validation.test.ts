...
import { validRegisterRequest, validCreateTaskRequest, validHeartbeatRequest, validTaskResult, validLogEntry, invalidInputs } from '../../../test/fixtures/mock-data';
...
describe('registerNodeRequestSchema', () => {
  ...
  it('rejects empty node name', () => {
    const result = registerNodeRequestSchema.safeParse({ ...validRegisterRequest, name: '' });
